...
sdk = UpsRating(access_token="YOUR_ACCESS_TOKEN", base_url=Environment.DEFAULT.value)
...
request_body = RateRequestWrapper(
    rate_request={
        "request": {
            ...
            "sub_version": "eu E",
            "transaction_reference": {"customer_context": "amet aliquip deserunt"},
        },
        "pickup_type": {"code": "co", "description": "ipsum aliquip minim quis"},
        "customer_classification": {"code": "ir", "description": "sunt consectetur"},
        "shipment": {
            ...
            "shipment_indication_type": [
                {"code": "la", "description": "sit sint occaecat"}
            ],
            "payment_details": {
                "shipment_charge": [
                    {
                        "type_": "nu",
                        "bill_shipper": {"account_number": "ea qui"},
                        "bill_receiver": {
                            "account_number": "Except",
                            "address": {"postal_code": "tempor"},
                        },
                        "bill_third_party": {
            ...
            "frs_payment_information": {
                "type_": {"code": "lab", "description": "dolor reprehenderit i"},
                "account_number": "sint t",
                "address": {"postal_code": "irure ", "country_code": "ir"},
            },
            "freight_shipment_information": {
                "freight_density_info": {
                    ...
                    "adjusted_height": {
                        "value": "in amet Ut",
                        "unit_of_measurement": {"code": "te", "description": "dolore"},
                    },
                    "handling_units": [
                        {
                            "quantity": "anim in ",
            ...
            "service": {"code": "ull", "description": "occae"},
            "num_of_pieces": "NumOfPieces",
            "shipment_total_weight": {
                "unit_of_measurement": {"code": "ad", "description": "esse laboris ad"},
                "weight": "Weight",
            },
            "documents_only_indicator": "DocumentsOnlyIndicator",
            "package": [
                {
                    "packaging_type": {"code": "co", "description": "quis nisi"},
                    "dimensions": {
                        "unit_of_measurement": {
                            "code": "l",
                    ...
                    "simple_rate": {"code": "nu", "description": "an"},
                    "ups_premier": {"category": "si"},
            ...
            "shipment_service_options": {
                ...
                "delivery_confirmation": {"dcis_type": "DCISType"},
                ...
                "import_control": {"code": "in", "description": "dolore eu"},
                "return_service": {
                    "code": "t",
            ...
            "invoice_line_total": {"currency_code": "dol", "monetary_value": "exerc"},
            ...
            "delivery_time_information": {
                ...
                "pickup": {"date_": "doelit E", "time": "sed "},
                "return_contract_services": [
                    {"code": "ve", "description": "Excepteur"}
                ],
            },
